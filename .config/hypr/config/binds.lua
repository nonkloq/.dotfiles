...
hl.bind("ALT + apostrophe", hl.dsp.layout("togglesplit"))
hl.bind("ALT + period", hl.dsp.window.center())
...
--- move window within workspace navigation
...
--- Monitor navigation: Move active window around monitors
...
--- Workspace navigation: Move active window around workspace
...
for i = 1, NUM_WPM do
	...
	hl.bind(mainMod .. " + SHIFT + " .. key, hl.dsp.window.move({ workspace = "e~" .. i }))
end
...
hl.bind(mainMod .. " + slash", hl.dsp.exec_cmd(noctCall .. "panel-toggle launcher"))
-- hl.bind(mainMod .. " + period", hl.dsp.exec_cmd(noctCall .. "panel-toggle launcher /emo"))
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd(noctCall .. "session lock"))
hl.bind(mainMod .. " + ALT + C", hl.dsp.exec_cmd(noctCall .. "panel-toggle session"))
hl.bind(mainMod .. " + SHIFT + R", hl.dsp.exec_cmd("~/.dotfiles/scripts/screencast.sh --region"))

hl.bind(mainMod .. " + CONTROL + SHIFT + R", hl.dsp.exec_cmd("~/.dotfiles/scripts/screencast.sh"))
...
hl.bind(mainMod .. " + Up", hl.plugin.gloview.toggle)
